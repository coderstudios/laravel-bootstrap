...
class Utf8
{
    ...
    |--------------------------------------------------------------------------
    |
    | Different UTF-8 string manipulation functions
    |
    */
    ...
    public function utf8_strpos($string, $needle, $offset = null)
    {
        if (is_null($offset)) {
            ...
            if (count($data) > 1) {
                return $this->utf8_strlen($data[0]);
            }
        ...
        if (false !== ($position = $this->utf8_strpos($string, $needle))) {
    ...
    public function utf8_strrpos($string, $needle, $offset = null)
    {
        ...
        if (false !== ($position = $this->utf8_strrpos($string, $needle))) {
            return $position + $offset;
        }
    ...
    public function utf8_from_unicode($data)
    {
        ob_start();
